            ...
            <table style="border: 1px solid #eee;">
                <tr>
                    ...
                    <td><?= form_dropdown('category_id', array(lang('news_no_category_select_label')) + $categories, @$article->category_id) ?>
                        [ <?= anchor('admin/news/categories/create', lang('news_new_category_label'), 'target="_blank"'); ?>
                        ]
                    </td>
                </tr>
                <tr>
                    <td><label for="title"><?= lang('news_title_label'); ?></label></td>
                    <td><?= form_input('title', htmlspecialchars_decode($article->title), 'maxlength="100"'); ?><span
                                class="required-icon tooltip"><?= lang('required_label'); ?></span></td>
                </tr>
                <tr>
